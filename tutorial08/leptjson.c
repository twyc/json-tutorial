...
int lept_is_equal(const lept_value* lhs, const lept_value* rhs) {
    ...
    switch (lhs->type) {
        ...
        case LEPT_OBJECT:
            ...
            {
                lept_value* t = lept_find_object_value(rhs, lhs->u.o.m[i].k, lhs->u.o.m[i].klen);
                if (t == NULL)
                    return 0;
                if (!lept_is_equal(&lhs->u.o.m[i].v, t))
                    return 0;
            }
            return 1;
        default:
...
lept_value* lept_set_object_value(lept_value* v, const char* key, size_t klen) {
    ...
    index = v->u.o.size;
    v->u.o.m[index].k = (char *)malloc((klen));
...
void lept_remove_object_value(lept_value* v, size_t index) {
    ...
    for (i = index; i < v->u.o.size; i++)
    {
        ...
        if (i != v->u.o.size - 1)
        {
            memcpy(v->u.o.m[i].k = (char *)malloc(v->u.o.m[i+1].klen), v->u.o.m[i+1].k, v->u.o.m[i+1].klen);
